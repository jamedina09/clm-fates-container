...
# ------------------------------------------------------------------
rm -rf /projects_mirror/scratch/CTSM_FATES_TEST
rm -rf /projects_mirror/archive/CTSM_FATES_TEST
...
# ------------------------------------------------------------------
./create_newcase --case "$CASE_DIR" --res "$RES" --compset "$COMP" --mach "$MACH" --compiler "${COMPILER}" --project "${PROJECT}" --run-unsupported
